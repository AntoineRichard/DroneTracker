...
class ROSDetect : public Detect, public rclcpp::Node {
  protected:
    ...
    // Image parameters
    sensor_msgs::msg::Image::Ptr image_ptr_out_;

    virtual void imageCallback(const sensor_msgs::msg::Image::SharedPtr);
...
class ROSDetectAndLocate : public ROSDetect, public Locate { // Should be using virtual classes
  protected:
    ...
    virtual void imageCallback(const sensor_msgs::msg::Image::SharedPtr) override;
    void depthInfoCallback(const sensor_msgs::msg::CameraInfo::SharedPtr);
    void depthCallback(const sensor_msgs::msg::Image::SharedPtr);
